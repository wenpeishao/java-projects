...
public class RedBlackTree<T extends Comparable<T>> {
  ...
  private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
    if(child==null||parent==null||child.parent!=parent||child.parent==null) {
    ...
    if (parent.leftChild.equals(child)) {
      ...
      Node<T> oldLeft = parent.leftChild;
      parent.leftChild = oldLeft.rightChild;
      if (parent.parent == null) {
        root = oldLeft;
      } else if (parent.parent.leftChild.equals(parent)) {
        parent.parent.leftChild = oldLeft;
      } else {
        parent.parent.rightChild = oldLeft;
      }
      oldLeft.rightChild = parent;
    } else if (parent.rightChild.equals(child)) {
      if (parent.rightChild == null) {
        return;
      }
      Node<T> oldRight = parent.rightChild;
      parent.rightChild = oldRight.leftChild;
      if (parent.parent == null) {
        root = oldRight;
      } else if (parent.parent.leftChild.equals(parent)) {
        parent.parent.leftChild = oldRight;
      } else {
        parent.parent.rightChild = oldRight;
      }
      oldRight.leftChild = parent;
  ...
  /**
   * First tester class test right rotation (basic)
   * @return test result
   */
   public static boolean test1() { 
     ...
     RBT.insert(5);
     RBT.insert(7);
     RBT.rotateTester(RBT.root.leftChild.rightChild, RBT.root.leftChild);
     if(RBT.toLevelOrderString().equals("[ 4, 3, 6, 2, 5, 7, 1 ]")) {
       return true;
     }
     }catch (Exception e) {
       return false;
...
/**
 * second tester class test left rotation(adcance)
 * @return test result
 */
    public static boolean test2() {
      ...
      RBT2.insert(2);
      RBT2.insert(1);
      RBT2.rotateTester(RBT2.root.leftChild,RBT2.root);
      if(RBT2.toLevelOrderString().equals("[ 2, 1, 4 ]")) {
        return true;
      }
      }catch (Exception e) {
        return false;
 ...
 /**
  * Third tester class test the wrong input. Is the class throws proper exception
  * @return test result
  */
    public static boolean test3() { 
      ...
      RBT2.insert(2);
      RBT2.insert(1);
      RBT2.rotateTester(RBT2.root,RBT2.root.leftChild);
