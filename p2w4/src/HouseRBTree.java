 ...
 */
public class HouseRBTree<HouseADT> implements IRBTree {
     ...
     */
    private boolean containsHelper(Housey data, HouseNode subtree) {
        if (subtree == null) {
	...
	*/	
	...
	public boolean contains(Comparable data) {
		return this.containsHelper((Housey)data, root);
	}
	...
	/**
	   ...
	   */
	@Override
	public Housey remove(Comparable data) {
	 ...
	 * @return node of data
	 */
	private HouseNode findHouseNode(Housey data, HouseNode subtree) {
//		if (subtree == null) {
//            // we are at a null child, value is not in tree
//            return false;
//        } else {
