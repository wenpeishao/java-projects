 ...
 * EdgeType the data type stored at each graph edge as
 *   a Number whose doubleValue() method returns a value >=0.0
 */
public interface GraphADT<NodeType, EdgeType extends Number> {

  /**
   * This method will allow the user to select the vertex at which they want to start
   * This will affect where/how dijkstra's algorithm will branch out to
